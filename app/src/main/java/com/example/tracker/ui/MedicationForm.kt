...
class MedicationForm : AppCompatActivity() {
    ...
    private fun setupDatePickerStart() {
        val dateInput = findViewById<com.google.android.material.textfield.TextInputEditText>(R.id.etStartDate)
    ...
    private fun setupDatePickerEnd() {
        val dateInput = findViewById<com.google.android.material.textfield.TextInputEditText>(R.id.etEndDate)
